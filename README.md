...
-Choosing the best-fitting dataset and uploading it in R studio.

-Managing and working with data, adding and recoding variables in order to only kept the useful ones.

-Scraping newspapers arcticles about italian Mario Monti's and Mario Draghi's technocratic governments from different european newspapers websites.

-Providing a visual analysis of our findings from ParlGov's datasets

-Providing a sentiment analysis of newspapers arcticles

-Obtaining Monti's and Draghi's inaugural speeches
