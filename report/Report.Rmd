---
title: "Instability And Technocracy In Italy: A Bird's Eye View"
author: "Ruzza Tomas, Sioli Lorenzo, Destro Nicola"
date: "01/03/2021"
output: 
subtitle: DAPS&CO - Data Access and Regulation, Module II
---
...
```
WORDCOUNT:
```{r words,results = TRUE}
wordcount <- wordcountaddin::word_count(here::here("report", "Report.rmd"))
wordcount
```


### Introduction
This project goal was initially to analise and visualize the Italian Republican history following its governments and, most importantly, its government crisis.
As Italian young citizens we are very familiar with some of the stereotypes revolving around our political system, one of the strongest being the great instability.
The numbers around our frequent crisis are object of continuous discussion and, as such, are often reported imprecisely.
We decided to create a dataset that could help us describe exactly the phenomenon of political instability in Italy, both in terms of the time that our country has spent "suspended" by it and in terms of the impact that this behaviour has on the very nature of our governments.
One of the inspirations for our work was Gabanelli's and Ravizza's article "Crisi di governo: 66 esecutivi in 75 anni. Quanto ci costa l’instabilità politica?", published on the Italian newspaper "Corriere della Sera" which helped us in designing our visualization.


From this very simple idea our project evolved widening again and again the spectrum of our analysis towards two main directions: the comparison between Italy and the other European countries and a focus on our current circumstances, the advent of Mario Draghi and with him of the 4th Italian experience with a form of technocracy.

The second step of our work was motivated by a common interest for the concept of technocracy and inspired by the reading of a marvelous PhD thesis on the topic ("Technocratic Governments: Power, Expertise and Crisis Politics in European Democracies", Pastorella 2016). 
The pandemics is generating new challenges for European countries and democracies in general, crisis seems to be the main due condition for technocracies to pop up; this made us want to include this topic in our project, we think it could be one of the most important for EU's close future and Italy could represent just the first chapter.

The following step was for us to focus on Italy's last two experiences with technocracy: Monti, and Draghi.
This process was divided into two: a sentiment analysis of foreign papers and a text analysis of the inaugural speeches of each Prime Minister.

It is very important to say that the main and greater purpose of our project was to challenge ourselves and our newly acquired skill-set; we tried to experiment with R as much as we could, we used a variety of packages and played with different ideas for analysis and visualization. We are glad to say that we also had real good fun in doing so.
...
### The history of Italian government crisis

We went on with our analysis starting from the visualization of our data.
First, we wanted to compare the crisis time between each government and the averages and highlights of the Italian cabinets.
...
The high instability of the italian majorities led too several early elections turn, making this practice very common both in the "Prima" and "Seconda Repubblica".
...
The graph properly shows the behavior of Italian republican democracy and its instability and tendency to short governments and legislatures (66 cabinets in 75 years).
...
However, most of the highest bars in our graph are in correspondence of new elections and consequent electoral campaigns, both for natural end of the legislature and for the call to early elections.
...
### Caretaker governments and technocracies, an European overview

In light of our analysis of the Italian history and situation we wanted to compare it with similar political realities, i.e. Europe.
...
### Foreign perception of Italy: newspapers analysis
The specificity of the countries and time periods that hosted caretaker governments immediately led us to think to some sort of dichotomy between the political establishments who needed them, and those who did not.
...
### Monti and Draghi inaugural speeches: different technocracies
...
Even if our capstone project could explore way further the concepts that we touched upon, we hope it results in an interesting basic description of the topics we decided to inquire.
Jumping from one "question" to the next we had the occasion to really understand R's power and to set the stage for many future possible deeper reflections and analysis.

We are very happy with our personal accomplishments, we think we enhanced every aspect of our programming work-flow, and most importantly this project felt like a good, softer, preview of how part of our future work and research will look like.

We believe that there is much to say around the topics we encountered; much can be done for Italy through the understanding of its instability as it is one of the primary cause of distrust in politics for our generation.
Moreover, technocracies are in our opinion something that will gather more and more importance and interest within the next years; many parties in Europe are shifting their focuses towards technicality and competence, and the world is providing challenges, tools and technologies that will require new paradigms perhaps based on this very staples and political models. 
